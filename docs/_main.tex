...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Task 1 – Basic Filtering}
\CommentTok{\# Use a for loop with if/else conditions}
\CommentTok{\# Go through each row of the dataset and:}
\CommentTok{\# Print a message if the patient has High BP (\textgreater{} 140) \# Tip: use the paste function, }
\CommentTok{\# Print a message if the patient has Low BP (\textless{} 90)}
\CommentTok{\# Otherwise, mark them as Normal}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Plot multiple panels in one plot}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Histogram of Blood Pressure}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Boxplot of BP by Gender}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Scatterplot Age vs BP}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Customizing ggplot2}
\FunctionTok{ggplot}\NormalTok{(bp\_data, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Age, }\AttributeTok{y =}\NormalTok{ BloodPressure)) }\SpecialCharTok{+}
